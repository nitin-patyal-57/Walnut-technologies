  ...
  return (
    <footer className="relative bg-white text-gray-900 overflow-hidden">
      ...
      <button
        ...
        className="fixed bottom-24 lg:bottom-6 left-6 z-40 w-10 h-10 rounded-xl bg-gray-100 border border-gray-200 text-gray-500 hover:text-cyan-600 hover:bg-cyan-50 focus:outline-none focus:ring-2 focus:ring-cyan-400 flex items-center justify-center transition-all shadow-sm"
      >
