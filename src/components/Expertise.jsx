...
const expertiseAreas = [
  ...
  },
  {
    ...
    image: '/embedded-electronics-and-iot.webp',
  },
  {
  ...
  return (
    <section id="expertise" className="relative bg-white">
      <div ref={heroRef} className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 md:pt-12 md:pb-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <img
                  src="/design-and-engineering.webp"
