...
const products = [
  {
    ...
    subtitle: 'Advanced rehabilitation robot',
    ...
    highlights: ['Rehabilitation Robot', 'AI-Assisted Therapy', 'Patient Dashboard', 'Tele-Rehab Ready'],
      ...
      <div className="flex items-start gap-5">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-lg shadow-blue-500/20">
              {product.number}
            </div>
            <div>
              <h3 className="font-bold text-[#0f172a] text-lg leading-tight">{product.title}</h3>
              <p className="text-blue-500 text-sm font-medium">{product.subtitle}</p>
            </div>
          </div>
    ...
    >
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p className="text-blue-500 text-sm font-medium">{capability.subtitle}</p>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <section ref={heroRef} className="relative">
        ...
        >
          <img src="/neuro.jpeg" alt="Neuro Rehab Devices" className="w-full h-auto" />
        </motion.div>
      </section>
