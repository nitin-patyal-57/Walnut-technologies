        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative rounded-xl overflow-hidden bg-slate-100 aspect-square mb-2">
                <img
                  src={step.image}
                  alt={step.title}
                  loading="lazy"
                ...
                <div className="absolute bottom-2 left-2 right-2">
                  <span className="text-[8px] font-bold text-blue-300 block">{step.num}</span>
                </div>
              </div>
              <h4 className="text-[11px] font-bold text-slate-900 uppercase tracking-wider text-center">{step.title}</h4>
            </motion.div>
          ))}
        </div>
