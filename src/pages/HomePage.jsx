    ...
    <section className="py-16 md:py-20 bg-white">
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-bold font-display text-slate-900 mb-3">In the News</h2>
          <p className="text-sm text-slate-500 max-w-xl mx-auto">Stay updated with our latest achievements and industry insights</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {latestNews.map((item, index) => (
            <motion.div
              ...
              className="group p-5 rounded-2xl border border-slate-100 bg-slate-50 hover:bg-white hover:border-slate-200 hover:shadow-lg transition-all duration-300"
            >
              <div className="flex items-center gap-2 mb-3">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-semibold bg-cyan-50 text-cyan-600 rounded-full">
                  <FiTag className="w-2.5 h-2.5" />
                  {item.type}
                </span>
                <span className="text-xs text-slate-400">{item.date}</span>
              </div>
              <h3 className="text-sm font-bold text-slate-900 mb-2 leading-snug group-hover:text-cyan-600 transition-colors line-clamp-2">{item.title}</h3>
        ...
        >
          <Link
            to="/news"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold rounded-xl transition-all duration-300"
          >
            View All News
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-br from-cyan-600 to-blue-700">
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white/90 text-sm font-semibold mb-4 backdrop-blur-sm">
            <FiMail className="w-4 h-4" />
            Newsletter
          </div>
          <h2 className="text-2xl md:text-3xl font-bold font-display text-white mb-3">Stay Updated</h2>
          <p className="text-sm text-white/70 mb-6">Get the latest insights on electronics manufacturing, medical devices, and fintech innovation delivered to your inbox.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 text-sm focus:outline-none focus:bg-white/20 focus:border-white/40 transition-all"
              required
            />
            <button
              type="submit"
              className="px-6 py-3 bg-white text-cyan-600 text-sm font-semibold rounded-xl hover:bg-white/90 transition-all duration-300 flex items-center justify-center gap-2 shrink-0"
            >
              {submitted ? (
                <>
