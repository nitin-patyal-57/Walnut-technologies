...
export const resources = [
  {
    id: 'whitepaper-1',
    title: 'ISO 13485 Compliance in Medical Device Manufacturing',
    type: 'Whitepaper',
    description: 'A comprehensive guide to achieving and maintaining ISO 13485 certification for medical device manufacturers. Covers quality management systems, risk-based thinking, and regulatory requirements.',
    icon: 'whitepaper',
    color: 'from-blue-600 to-cyan-500',
  },
  {
    id: 'case-study-1',
    title: 'WalkLab Robotic Gait Training: From Prototype to Clinical Deployment',
    type: 'Case Study',
    description: 'How Walnut Technologies developed and scaled the WalkLab Robotic Gait Training system from concept to FDA-approved neuro rehabilitation device with AI-assisted therapy.',
    icon: 'casestudy',
    color: 'from-purple-600 to-pink-500',
  },
  {
    id: 'brochure-1',
    title: 'Walnut Technologies Company Overview 2026',
    type: 'Brochure',
    description: 'Complete overview of our 150,000 sq.ft manufacturing facility, 4 SMT lines, Class 10K cleanroom, and end-to-end OEM/ODM capabilities across medical, fintech, and IoT divisions.',
    icon: 'brochure',
    color: 'from-amber-500 to-orange-600',
  },
  {
    id: 'whitepaper-2',
    title: 'PCI-DSS & EMV Certification for Payment Terminal Manufacturing',
    type: 'Whitepaper',
    description: 'Technical deep-dive into PCI-DSS compliance, EMV L1/L2 certification, and NPCI/RBI requirements for secure payment hardware development in India.',
    icon: 'whitepaper',
    color: 'from-emerald-600 to-teal-500',
  },
  {
    id: 'case-study-2',
    title: 'HDFC Bank POS Terminal Deployment: 10,000+ Units Across India',
    type: 'Case Study',
    description: 'Large-scale manufacturing and deployment of PCI-DSS certified POS payment terminals for HDFC Bank, covering design, production, certification, and nationwide logistics.',
    icon: 'casestudy',
    color: 'from-rose-600 to-red-500',
  },
  {
    id: 'brochure-2',
    title: 'Neuro Rehabilitation Devices Product Catalog',
    type: 'Brochure',
    description: 'Detailed catalog of WalkLab Gait Training, Walkex FES, rTMS MedStim, TDCS Mind Acquity, and CES Repose devices with specifications, clinical applications, and certifications.',
    icon: 'brochure',
